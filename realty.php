						...
						foreach ( $recent_items_results as $recent_item ) {
							...
							<div class="rlt_home_preview">
								...
								<div class="rlt_home_info">
									...
									<ul>
										<li><?php echo esc_html( $recent_item['property_info_location'] ); ?></li>
										<li><?php echo esc_html( $recent_item['property_info_bedroom'] . ' ' . _n( 'bedroom', 'bedrooms', absint( $recent_item['property_info_bedroom'] ), 'realty' ) . ', ' . $recent_item['property_info_bathroom'] .' ' . _n( 'bathroom', 'bathrooms', absint( $recent_item['property_info_bathroom'] ), 'realty' ) ); ?></li>
										<li><?php echo esc_html( $recent_item['property_info_square'] ) . ' ' . rlt_get_unit_area(); ?></li>
									</ul>
								</div>
								<div class="home_footer">
									<a class="<?php echo ( ! empty( $periods[ $recent_item['property_info_period'] ] ) ) ? "rent" : "sale"; ?>" href="<?php echo get_permalink( $recent_item['ID'] ); ?>"><?php echo esc_html( $types[$recent_item['property_info_type'] ] );?></a>
									<a href="<?php the_permalink(); ?>" class="add">&#160;</a>
									<span class="home_cost"><?php echo apply_filters( 'rlt_formatting_price', $recent_item['property_info_price'], rlt_get_currency() ); ?><sup><?php if ( ! empty( $recent_item['property_info_period'] ) ) echo "/" . esc_html( $periods[ $recent_item['property_info_period'] ] ); ?></sup></span>
									<div class="clear"></div>
								</div><!-- .home_footer -->
	...
	function rlt_property_custom_metabox() {
		...
		<table class="form-table rlt-info">
			<tr>
				...
				<td>
					<input type="text" id="rlt_location" size="40" name="rlt_location" value="<?php if ( ! empty( $property_info['property_info_location'] ) ) echo esc_html( $property_info['property_info_location'] ); ?>"/><br />
			...
			<tr>
				...
				<td>
					<input type="text" id="rlt_coordinates" size="40" name="rlt_coordinates" value="<?php if ( ! empty( $property_info['property_info_coordinates'] ) ) echo esc_html( $property_info['property_info_coordinates'] ); ?>"/><br />
			...
			<tr>
				<th><label for="rlt_price"><?php _e( 'Price', 'realty' ); ?>( <?php echo esc_html( $currency[0] ); ?> )</label></th>
				<td>
					<input type="text" id="rlt_price" name="rlt_price" value="<?php if ( ! empty( $property_info['property_info_price'] ) ) echo esc_html( $property_info['property_info_price'] ); ?>"/><br />
			...
			<tr>
				...
				<td>
					<input type="text" id="rlt_square" name="rlt_square" value="<?php if ( ! empty( $property_info['property_info_square'] ) ) echo esc_html( $property_info['property_info_square'] ); ?>"/><br />
			...
			<tr>
				...
				<td>
					<input type="number" id="rlt_bedroom" min="1" name="rlt_bedroom" value="<?php echo ! empty( $property_info['property_info_bedroom'] ) ? esc_html( $property_info['property_info_bedroom'] ) : "1"; ?>" />
				</td>
			</tr>
			<tr>
				<th><label for="rlt_bathroom"><?php _e( 'Bathrooms', 'realty' ); ?></label></th>
				<td>
					<input type="number" id="rlt_bathroom" min="1" name="rlt_bathroom" value="<?php echo ! empty( $property_info['property_info_bathroom'] ) ? esc_html( $property_info['property_info_bathroom'] ) : "1"; ?>" />
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<?php if ( ! empty( $property_info['property_info_photos'] ) ) {
						...
						foreach ( $property_info['property_info_photos'] as $rlt_photo ) { ?>
							<li id="<?php echo exc_attr( $rlt_photo ); ?>" class="rlt_image_block">
								<div class="rlt_drag">
									<div class="rlt_image">
									<?php $image_attributes = wp_get_attachment_image_src( $rlt_photo, 'thumbnail' ); ?>
									<img src="<?php echo esc_url( $image_attributes[0] ); ?>" title="" width="150" />
									</div>
									<div class="rlt_delete"><a href="javascript:void(0);" onclick="rlt_img_delete( <?php echo esc_attr( $rlt_photo ); ?> );"><?php _e( 'Delete', 'realty' ) ; ?></a></div>
									<input type="hidden" name="rlt_photos[]" value="<?php echo esc_attr( $rlt_photo ); ?>" />
								</div>
							</li>
						<?php }
					} ?>
					...
					<?php if ( ! empty( $property_info ) ) { ?>
					 <input type="hidden" value="<?php echo esc_attr( $property_info['property_info_id'] ); ?>" name="property_info_id" />
					<?php } ?>
					<div class="clear"></div>
				</td>
			</tr>
...
if ( ! function_exists( 'rlt_template_include' ) ) {
	function rlt_template_include( $template ) {
		...
		if ( ( function_exists( 'is_embed' ) && is_embed() ) || is_search() ) {
			return $template;
		}

		if ( ! empty( $post->ID ) && 'property' == get_post_type( $post->ID ) && ! isset( $_REQUEST['rlt_action'] ) ) {
			$file = 'rlt-listing.php';
		} elseif ( isset( $wp_query->query_vars['property_search_results'] ) || ( isset( $_REQUEST['rlt_action'] ) && 'listing_search' == $_REQUEST['rlt_action'] ) || isset( $wp_query->query_vars['property_paged'] ) ) {
	...
	function rlt_add_pdf_print_content( $content ) {
		...
		if ( 'property' == $current_post_type ) {
			...
			$custom_content .= '<div class="rlt_home_info">
					<ul>
						<li>' . esc_html( $property_info['property_info_location'] ) . '</li>
						<li>' . esc_html( $property_info['property_info_bedroom'] . ' ' . _n( 'bedroom', 'bedrooms', absint( $property_info['property_info_bedroom'] ), 'realty' ) . ', ' . $property_info['property_info_bathroom'] . ' ' . _n( 'bathroom', 'bathrooms', absint( $property_info['property_info_bathroom'] ), 'realty' ) ) . '</li>
						<li>' . esc_html( $property_info['property_info_square'] ) . ' ' . rlt_get_unit_area() . '</li>
					</ul>
				</div>
				<div class="home_footer">
					<a class="' . ( ! empty( $property_info['property_info_period'] ) ? "rent" : "sale" ) . '" href="' . get_permalink() . '">' . esc_html( $types[ $property_info['property_info_type'] ] ) . '</a>
					<span class="home_cost">' . apply_filters( 'rlt_formatting_price', $property_info['property_info_price'], true );
						if ( ! empty( $property_info['property_info_period'] ) ) {
							$custom_content .= '<sup>' . "/" . esc_html( $periods[ $property_info['property_info_period'] ] ) . '</sup>';
						}
					$custom_content .= '</span>
				</div>';
		}
			...
			foreach ( $property_info_results as $property_info ) {
				...
				<div class="rlt_home_preview">
					...
					<div class="rlt_home_info">
						...
						<ul>
							<li><?php echo esc_html( $property_info['property_info_location'] ); ?></li>
							<li><?php echo esc_html( $property_info['property_info_bedroom'] . ' ' . _n( 'bedroom', 'bedrooms', absint( $property_info['property_info_bedroom'] ), 'realty' ) . ', ' . $property_info['property_info_bathroom'] . ' ' . _n( 'bathroom', 'bathrooms', absint( $property_info['property_info_bathroom'] ), 'realty' ) ); ?></li>
							<li><?php echo esc_html( $property_info['property_info_square'] ) . ' ' . rlt_get_unit_area(); ?></li>
						</ul>
					</div>
					<div class="home_footer">
						<a class="<?php if( ! empty( $property_info['property_info_type'] ) ) echo "rent"; else echo "sale"; ?>" href="<?php echo get_permalink( $property_info['ID'] ); ?>"><?php echo esc_html( $types[ $property_info['property_info_type'] ] ); ?></a>
						<a href="<?php the_permalink(); ?>" class="add">&#160;</a>
							<span class="home_cost"><?php echo esc_html( apply_filters( 'rlt_formatting_price', $property_info['property_info_price'], true ) ); ?><sup><?php if ( ! empty( $property_info['property_info_period'] ) ) echo "/" . esc_html( $periods[ $property_info['property_info_period'] ] ); ?></sup></span>
							<div class="clear"></div>
					</div><!-- .home_footer -->
				</div><!-- .rlt_home_preview -->
			<?php } ?>
		...
		<div class="rlt_search_options rlt_home_info_full">
			<div class="rlt_home_preview">
				...
				<div class="home_footer">
					...
					<span class="home_cost"><?php echo esc_html( apply_filters( 'rlt_formatting_price', $property_info['property_info_price'], true ) ); ?><sup><?php if ( ! empty( $property_period_name ) ) echo "/" . esc_html( $property_period_name ); ?></sup></span>
				</div>
			</div>
